...
import SettingDarkIcon from 'icon/assets-setting-dark.svg?component';
import SettingLightIcon from 'icon/assets-setting-light.svg?component';
import SettingAutoIcon from 'icon/assets-setting-auto.svg?component';
...
const showSettingPanel = computed({
  get() {
    return setting.value.showSettingPanel;
  },
  set(newVal: boolean) {
