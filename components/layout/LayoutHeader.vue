    ...
    <t-head-menu :class="menuCls" :theme="theme" expand-type="popup" :value="active">
      <template #logo>
        ...
        <div v-else class="header-operate-left">
          ...
          <LayoutSearch :layout="layout" />
        </div>
      </template>
      <LayoutMenuContent v-show="layout !== 'side'" class="header-menu" :nav-data="menu" />
      <template #operations>
        <div class="operations-container">
          <!-- 搜索框 -->
          <LayoutSearch v-if="layout !== 'side'" :layout="layout" />
...
import LogoFull from 'icon/assets-logo-full.svg?component';
...
const changeCollapsed = () => {
  settingStore.updateConfig({
    isSidebarCompact: !settingStore.setting.isSidebarCompact,
  });
};
...
const navToGitHub = () => {
  window.open('https://github.com/yixiaco/tdesign-vue-next-nuxt-starter');
};
